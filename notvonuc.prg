...
*- PART 3: UCC128 part of the label - VON MAUR CORP. (02/19/2009)
*- ----------------------------------------------------------------------------------------------------------------------- -*
...
lcStringBlock3 = lcStringBlock3 + '#T150.0#J'+str(lnOffset+65)+'#YT108/2///'+'CASE QTY: '+ ;
...
ENDIF
lcStringBlock3 = lcStringBlock3 + '#T95.0#J'+str(lnOffset+3)+'#YT102/2///'+'FOR:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T90.0#J'+STR(lnOffset+12)+'#YT109/2///STORE ##:'+ALLTRIM(store)+'#G'
