...
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+44)+'#YT108/2///'+'SKUs Enclosed and quantity:'+'#G'

lcStringBlock3 = lcStringBlock3 + lcSkuList
...
*- Zone G/H
lcStringBlock3 = lcStringBlock3 + '#T93.0#J'+str(lnOffset+25)+'#YB15/2M/2.5/6///'+alltrim(carton_num)+'#G'
	
*- Zone I (Carton # [UCC128])

lcStringBlock3 = lcStringBlock3 + '#T93.0#J'+str(lnOffset+70)+'#YB15/2M/5.5/4///'+alltrim(barcodeSKU)+'#G'
