...
*- this Foxpro program NOTBLKUC.PRG (orig: NOTBLLUC.PRG)
...
*- PART 3: UCC128 part of the label - BELK (05/19/2005)
*- ----------------------------------------------------------------------------------------------------------------------- -*
...
lcStringBlock3 = lcStringBlock3 + '#T51.5#J'+str(lnOffset+0)+'#YL0/1/1/30#G'
...
lcStringBlock3 = lcStringBlock3 + '#T160.0#J'+str(lnOffset+65)+'#YT108/2///'+'DEPT: '+alltrim(department)+'#G'
if (LEN(alltrim(lcFOB))>0) then
  lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+70)+'#YT108/2///'+alltrim(lcFOB)+'#G'
endif
...
IF LEN(lcStore)<>4 then
  lcStore = '0'+lcStore
ENDIF
lcStringBlock3 = lcStringBlock3 + '#T93.0#J'+STR(lnOffset+24)+'#YB15/2O/3/5///91'+ALLTRIM(lcStore)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T83.0#J'+str(lnOffset+28)+'#YT107/2///(91)'+alltrim(lcStore)+'#G'

*- Zone H (Mark for store # [text])

lcStringBlock3 = lcStringBlock3 + '#T50.0#J'+str(lnOffset+2)+'#YT105/2///'+'STORE:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#M3/3#T50.0#J'+str(lnOffset+27)+'#YT109/2///'+alltrim(store)+'#G#M1/1'

*- Zone I (Carton # [UCC128])

lcStringBlock3 = lcStringBlock3 + '#T93.0#J'+str(lnOffset+69)+'#YB15/2O/5.5/5///'+alltrim(carton_num)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T93.0#J'+str(lnOffset+35)+'#YT108/2///('+substr(carton_num,1,2)+ ;
