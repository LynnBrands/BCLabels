...
*- PART 3: UCC128 part of the label - BEALLS (05/19/2005)
*- ----------------------------------------------------------------------------------------------------------------------- -*
...
DO WHILE NOT EOF('CurPart2Final') 
	...
	*lcStringBlock2=lcStringBlock2+SPACE(5)
	...
	lcStringBlock2=lcStringBlock2+'#T160.0#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Size'+'#G'
	lcStringBlock2=lcStringBlock2+'#T152.0#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'SKU/UPC'+'#G'
	...
	*- second column header
	...
	lcStringBlock2=lcStringBlock2+'#T60.0#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Size'+'#G'
	lcStringBlock2=lcStringBlock2+'#T52.0#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'SKU/UPC'+'#G'
...
*			padr(color_code,6)+'#G'
		...
		*- SKU/UPC
		lcStringBlock2=lcStringBlock2+'#T152.0#J'+str(lnOffset+17+(lnIndLineBlock2*3))+'#YT102/2///'+ ;
			padr(SKU_UPC,12)+'#G'
...
*			padr(color_code_col2,6)+'#G'
		...
		*- SKU/UPC - Column 2
		lcStringBlock2=lcStringBlock2+'#T52.0#J'+str(lnOffset+17+(lnIndLineBlock2*3))+'#YT102/2///'+ ;
...
lcStringBlock3 = lcStringBlock3 + '#T50.0#J'+str(lnOffset+8)+'#YT105/2///'+'STORE:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T47.0#J'+str(lnOffset+26)+'#M2/3#YT109/2///'+alltrim(store)+'#G#M1/1'
