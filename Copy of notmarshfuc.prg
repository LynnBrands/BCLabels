...
DO WHILE NOT EOF('curPart1') 
	...
	*- Header line 1
	lcStringBlock1=lcStringBlock1+'#T138.0#J05.0#YT107/2///'+'L.A.M.B. Carton Pick Slip (Internal)'+'#G'
	...
	*lcStringBlock1=lcStringBlock1+SPACE(5)
	...
	lcStringBlock1=lcStringBlock1+'#T66.6#J'+str(lnOffset+8)+'#YT103/2///'+'L.A.M.B. Order ##:'+'#G'
...
DO WHILE NOT EOF('CurPart2Final') 
	...
	*lcStringBlock2=lcStringBlock2+SPACE(5)
	...
	lcStringBlock2=lcStringBlock2+'#T66.6#J'+str(lnOffset+4)+'#YT102/2///'+ ;
		'L.A.M.B. Order ##: '+left(allt(str(ord_num)),15)+'#G'
...
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+6)+'#YT102/2///'+'L.A.M.B.'+'#G'
...
ENDIF
lcStringBlock3 = lcStringBlock3 + '#T95.0#J'+str(lnOffset+12)+'#YT102/2///'+'FOR:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#M2/2#T90.0#J'+str(lnOffset+12)+'#YT108/2///##'+ALLTRIM(store)+' '+ ;
