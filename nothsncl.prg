...
*- this Foxpro program NOTHSNCL.PRG (orig: NOTPCLUC.PRG)
...
*- PART 3: Shipping label for HSN.  This format is not SSCC-18 compliant. (07/23/2008)
*- ----------------------------------------------------------------------------------------------------------------------- -*
...
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+6)+'#YT102/2///'+'VENDOR CODE: 316297'+'#G'
...
lcStringBlock3 = lcStringBlock3 + '#T170.0#J'+str(lnOffset+18)+'#YT102/2///'+'18974'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+24)+'#YT102/2///'+'SO##:'+alltrim(str(ord_num))+'#G'
...
ENDIF
lcStringBlock3 = lcStringBlock3 + '#T158.0#J'+str(lnOffset+2)+'#YT106/2///'+'SHIP TO:'+'#G'
...
*- Zone C (PO Number [Code128-A])

lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+32)+'#YT100/2///P.O. NUMBER#G'
lcStringBlock3 = lcStringBlock3 + '#T188.0#J'+str(lnOffset+58)+'#YB24/2M /3/4///'+alltrim(po_num)+'#G'

*- Zone D (Country of Origin)
lcStringBlock3 = lcStringBlock3 + '#T135.0#J'+str(lnOffset+40)+'#YT103/2///COUNTRY OF ORIGIN#G'
lcStringBlock3 = lcStringBlock3 + '#T135.0#J'+str(lnOffset+50)+'#YT103/2///__________________#G'

*- Zone E (End Date / Vendor Style #)

lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+65)+'#YT108/2///'+alltrim(dtoc(end_date))+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+70)+'#YT108/2///'+'Vendor Item ##: '+alltrim(style)+'#G'

*- Zone F (if not combined with Zone E)

*- Zone G (Carton X of Y)

lcStringBlock3 = lcStringBlock3 + '#T90.0#J'+str(lnOffset+15)+'#YT108/2///'+'CARTON _______ OF ________ #G'

*- Zone H (not used)

*- Zone I (Carton # [UCC128])

lcStringBlock3 = lcStringBlock3 + '#T93.0#J'+str(lnOffset+35)+'#YT100/2///UPC Number#G'
lcStringBlock3 = lcStringBlock3 + '#T40.0#J'+str(lnOffset+35)+'#YT100/2///Carton Quantity#G'
lcStringBlock3 = lcStringBlock3 + '#T93.0#J'+str(lnOffset+69)+'#YB2/2M/3.5/5///'+alltrim(lcUPC+lcUPC_chk)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T40.0#J'+STR(lnOffset+70)+'#YB24/2M /3.5/5///'+alltrim(str(lnTotalBlockQty))+'#G'
