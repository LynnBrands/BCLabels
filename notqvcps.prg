...
*- this Foxpro program NOTQVCPS.PRG (orig: NOTPCLUC.PRG)
...
*- PART 3: UCC128 part of the label - QVC (5/16/2005)
*- ----------------------------------------------------------------------------------------------------------------------- -*
...
scan
	...
	*- Add one new record in CurPart2
	...
	lcSKU_UPC = alltrim(lcSKU_UPC)	
        lcSKU_color = alltrim(lcSKU_color)
	replace SKU_UPC with lcSKU_UPC in CurPart2
        replace color_code with lcSKU_color in CurPart2
endscan
...
DO WHILE NOT EOF('CurPart2Final') 
	...
	*lcStringBlock2=lcStringBlock2+SPACE(5)
	...
	lcStringBlock2=lcStringBlock2+'#T150.0#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Size'+'#G'
	lcStringBlock2=lcStringBlock2+'#T140.0#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'SKU/UPC'+'#G'
	lcStringBlock2=lcStringBlock2+'#T115.0#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Qty'+'#G'
	*- second column header
	...
	lcStringBlock2=lcStringBlock2+'#T50.0#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Size'+'#G'
	lcStringBlock2=lcStringBlock2+'#T40.0#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'SKU/UPC'+'#G'
	lcStringBlock2=lcStringBlock2+'#T15.0#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Qty'+'#G'
	...
	DO WHILE !eof('curPart2Final') AND lnIndLineBlock2<=MaxNbLineBlock2
		...
		*- SKU/UPC
		lcStringBlock2=lcStringBlock2+'#T140.0#J'+str(lnOffset+17+(lnIndLineBlock2*3))+'#YT102/2///'+ ;
			alltrim(SKU_UPC)+'#G'
		
		*- Qty
		lcStringBlock2=lcStringBlock2+'#T115.0#J'+str(lnOffset+17+(lnIndLineBlock2*3))+'#YT102/2///'+ ;
		...
		*- SKU/UPC - Column 2
		lcStringBlock2=lcStringBlock2+'#T40.0#J'+str(lnOffset+17+(lnIndLineBlock2*3))+'#YT102/2///'+ ;
			alltrim(SKU_UPC_col2)+'#G'
		
		*- Qty - Column 2
		lcStringBlock2=lcStringBlock2+'#T15.0#J'+str(lnOffset+17+(lnIndLineBlock2*3))+'#YT102/2///'+ ;
...
* lcStringBlock3 = lcStringBlock3 + '#T188.0#J'+str(lnOffset+58)+'#YB15/2M B/3.5/5///(420)'+alltrim(sfsship_zip)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+40)+'#YT109/2///'+'PO## '+alltrim(po_num)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+50)+'#YT109/2///'+'QVC ITEM## '+alltrim(SKU_UPC)+'#G'

*- Zone D (Carrier, etc.)

*- Zone E (PO / Dept)

lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+STR(lnOffset+65)+'#YT107/2///'+'STYLE '+ALLTRIM(style)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+STR(lnOffset+70)+'#YT107/2///'+'SIZE '+ALLTRIM(size_desc)+'#G'
if len(lcSKU_color) > 11 then
  lccc = substr(lcSKU_color,1,11)
else
  lccc = alltrim(lcSKU_color)
endif
lcStringBlock3 = lcStringBlock3 + '#T150.0#J'+STR(lnOffset+65)+'#YT107/2///'+'COLOR '+lccc+'#G'
lcStringBlock3 = lcStringBlock3 + '#T150.0#J'+STR(lnOffset+70)+'#YT107/2///'+'QUANTITY '+STR(Total_qty,6)+'#G'
...
ENDIF
*lcStringBlock3 = lcStringBlock3 + '#T95.0#J'+str(lnOffset+8)+'#YT105/2///'+'FOR:'+'#G'
*lcStringBlock3 = lcStringBlock3 + '#T80.0#J'+str(lnOffset+8)+'#YT108/2///'+alltrim(sfsstore_name)+'  ##'+ ;
*	alltrim(store)+'#G'
...
lcStringBlock3 = lcStringBlock3 + '#T93.0#J'+str(lnOffset+70)+'#YB15/2M/7/5///'+alltrim(SKU_UPC)+'#G'
...
*-----------------------------------------------------------------------------
*- FUNCTION qvc_color(customer,style,color)
