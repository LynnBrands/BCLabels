...
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+65)+'#YT108/2///'+'STYLE: '+alltrim(style)+'/'+alltrim(color_code)+ ;
	' - '+alltrim(str(lnTotalBlockQty))+' UNITS TOTAL'+'#G'
if isPrepack then
	lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+70)+'#YT108/2///INNER '+pack_description+'#G'
else
	lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+70)+'#YT108/2///INNER QTY '+casedescription+'#G'
endif
