...
lcStringBlock3 = lcStringBlock3 + '#T101.6#J'+str(lnOffset+40)+'#YL0/2/1/101.6#G'
...
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+30)+'#YT102/2///RETAIL:#G'
lcStringBlock3 = lcStringBlock3 + '#T110.0#J'+str(lnOffset+36)+'#YT104/2R///TOTAL QTY: '+str(lnTotalBlockQty)+'#G'

*- Zone D (Carrier, etc.)

*- Zone E (PO / Dept)
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+43)+'#YT102/2///RECEIVING#G'
lcReceivingCartonNumber = '8'+SUBSTR(alltrim(carton_num),2,20)
lcStringBlock3 = lcStringBlock3 + '#T193.0#J'+str(lnOffset+70)+'#YB15/2M/3/6///'+alltrim(lcReceivingCartonNumber)+'#G'
...
DO WHILE NOT EOF('CurPart2Final') 
		*- Style
		lcStringBlock3=lcStringBlock3+'#T100.0#J'+str(lnOffset+(lnIndLineBlock2*3))+'#YT103/2///'+ ;
			padr(style,10)+'#G'
		
		*- Color
		lcStringBlock3=lcStringBlock3+'#T80.0#J'+str(lnOffset+(lnIndLineBlock2*3))+'#YT103/2///'+ ;
			padr(color_code,6)+'#G'

		*- Label
		lcStringBlock3=lcStringBlock3+'#T70.0#J'+str(lnOffset+(lnIndLineBlock2*3))+'#YT103/2///'+ ;
			padr(lbl_code,6)+'#G'

		*- Size
		lcStringBlock3=lcStringBlock3+'#T55.0#J'+str(lnOffset+(lnIndLineBlock2*3))+'#YT103/2///'+ ;
			padr(size_desc,6)+':#G'

		*- Qty
		lcStringBlock3=lcStringBlock3+'#T33.3#J'+str(lnOffset+(lnIndLineBlock2*3))+'#YT103/2///'+ ;
			padr(str(Total_qty,6),6)+' pcs#G'
...
lcStringBlock3 = lcStringBlock3 + '#T100.0#J'+str(lnOffset+43)+'#YT102/2///SHIPPING#G'
lcStringBlock3 = lcStringBlock3 + '#T93.0#J'+str(lnOffset+70)+'#YB15/2M/3/6///'+alltrim(carton_num)+'#G'

*- End

lcStringBlock3 = lcStringBlock3 + '#Q1#G'
??? '#!A1#IMS203.2/79.5#ERN1'
??? lcStringBlock3
