...
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+7)+'#YT103/2///'+'LYNN BRANDS, LLC'+'#G'
...
ENDIF
IF alltrim(location)=='WMELKO' THEN
  lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+10)+'#YT103/2///'+'140 N. ORANGE AVENUE'+'#G'
  lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+13)+'#YT103/2///'+'CITY OF INDUSTRY, CA'+'#G'
  lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+16)+'#YT103/2///'+'              91744'+'#G'
ENDIF
