...
*- this Foxpro program NOTGDYUC.PRG (orig: NOTPCLUC.PRG)
...
*- PART 3: UCC128 part of the label - GOODYS (5/18/2005)
*- ----------------------------------------------------------------------------------------------------------------------- -*
...
lcStringBlock3 = lcStringBlock3 + '#T115.0#J'+str(lnOffset+0)+'#YL0/1/1/75#G'
...
lcStringBlock3 = lcStringBlock3 + '#T203.2#J'+str(lnOffset+60)+'#YL0/2/1/88.2#G'
...
if substr(style,1,1)="F" then
  lcStringBlock3 = lcStringBlock3 + '#T135.0#J'+str(lnOffset+50)+'#YT102/2///FOLDED#G'
else
  lcStringBlock3 = lcStringBlock3 + '#T135.0#J'+str(lnOffset+50)+'#YT102/2///HANGING#G'
endif
...
lcStringBlock3 = lcStringBlock3 + '#T80.0#J'+str(lnOffset+8)+'#YT108/2///##'+alltrim(store)+' '+ ;
	alltrim(sfsstore_name)+'#G'
