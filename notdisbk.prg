...
*- this Foxpro program NOTDISBK.PRG (orig: NOTPCLUC.PRG)
...
*- PART 3: Custom part of the label - CHADWICKS / DISTINCTIVE APPAREL (10/18/2012)
*- ----------------------------------------------------------------------------------------------------------------------- -*
...
??? "#!A1#IMS203.2/317.0#ERN1"   && 8" wide by 12" long "Page"
...
*- 1) Distinctive Apparel, Inc.’s 10 digit Purchase Order number.
*- 2) Item Number (e.g. 12345 GRN 08) and a Barcode 39 with the Item Number as the code “data”
*- if you have a question about this barcode please send an email to
*- compliance@3plwporldwide.com
*- 3) Carton Quantity and a Barcode 39 with the carton quantity as the code “data”
*- 4) Gross weight (weight of carton and contents).
*- 5) Country of origin.
*- 6) Shipped “From” and “To” information - on a separate part.
*- 7) The carton type (i.e. #1, #5, #6, #7 or #8) - will be handwritten.
...
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+6)+'#YT106/2///'+'FROM:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+12)+'#YT108/2///'+'NOTATIONS, INC.'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+18)+'#YT108/2///'+'539 JACKSONVILLE RD.'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+24)+'#YT108/2///'+'WARMINSTER, PA'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T170.0#J'+str(lnOffset+30)+'#YT108/2///'+'18974'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+33)+'#YT102/2///'+'SO##:'+alltrim(str(ord_num))+'#G'
...
lcStringBlock3 = lcStringBlock3 + '#T124.0#J'+str(lnOffset+30)+'#YT106/2///'+'TO:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T120.0#J'+str(lnOffset+36)+'#YT108/2///'+B_NAME+'#G'
lcStringBlock3 = lcStringBlock3 + '#T120.0#J'+str(lnOffset+42)+'#YT108/2///'+B_ADDR1+'#G'
lcStringBlock3 = lcStringBlock3 + '#T120.0#J'+str(lnOffset+48)+'#YT108/2///'+B_ADDR2+'#G'
lcStringBlock3 = lcStringBlock3 + '#T120.0#J'+str(lnOffset+54)+'#YT108/2///'+B_CSZ+'#G'
