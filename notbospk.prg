...
lcStringBlock3 = lcStringBlock3 + '#T150.0#J'+str(lnOffset+64)+'#YT107/2///'+'Style: '+alltrim(style)+'#G'
...
lcStringBlock3 = lcStringBlock3 + '#T80.0#J'+str(lnOffset+8)+'#YT108/2///##'+alltrim(store)+'#G'
