...
*- this Foxpro program NOTDRSUC.PRG (orig: NOTPCLUC.PRG)
...
*- PART 3: UCC128 part of the label - DRESS BARN (01/31/11)
*- ----------------------------------------------------------------------------------------------------------------------- -*
...
*- **-- BOOKMARK --** To Do: Add note line from customer master at this location, moving everything else down.
...
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+35)+'#YT108/2///'+'BUSINESS UNIT: '+'DB INC.'+'#G'
if (alltrim(division)='3' or alltrim(division)='13' or alltrim(division)='27') then
	lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+40)+'#YT108/2///'+'DIVISION: '+'DRESS BARN WOMAN'+'#G'
else
	lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+40)+'#YT108/2///'+'DIVISION: '+'DRESS BARN'+'#G'
endif
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+45)+'#YT108/2///'+'PO: '+alltrim(po_num)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+50)+'#YT108/2///'+'SIZE: '+lcSizeList+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+55)+'#YT108/2///'+'PREPACK: 10 UNITS PER PACK#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+60)+'#YT108/2///'+'COLOR: '+alltrim(lcCustColor)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+65)+'#YT108/2///'+'SKU: '+alltrim(lcSKU_UPC)+'#G'
...
lcStringBlock3 = lcStringBlock3 + '#T100.0#J'+str(lnOffset+20)+'#YT109/2///'+'QUANTITY: '+alltrim(str(lnTotalBlockQty))+'#G'
lcStringBlock3 = lcStringBlock3 + '#T100.0#J'+str(lnOffset+28)+'#YT109/2///'+'PACKS: '+alltrim(str(lnTotalBlockQty/10))+'#G'
...
if lnPageNum = 4 then
  ...
  ??? lcStringBlock3
  ??? '#!A1#IMS203.2/79.4#ERN1'
  lnPageNum = 0
endif

*- ***************************************
*- Repeat PART 3 of the label, but with a minimum font of 5/16"
*- ***************************************
*- Make all customer specific changes here
*- ***************************************
...
lcStringBlock3 = lcStringBlock3 + '#T81.6#J'+str(lnOffset+0)+'#YL0/1/1/75#G'
*lcStringBlock3 = lcStringBlock3 + '#T101.6#J'+str(lnOffset+30)+'#YL0/2/1/101.6#G'
lcStringBlock3 = lcStringBlock3 + '#T203.2#J'+str(lnOffset+42)+'#YL0/2/1/121.6#G'
* lcStringBlock3 = lcStringBlock3 + '#T203.2#J'+str(lnOffset+60)+'#YL0/2/1/101.6#G'
lcStringBlock3 = lcStringBlock3 + '#T141.2#J'+str(lnOffset+0)+'#YL0/1/1/42#G'
* lcStringBlock3 = lcStringBlock3 + '#T140.1#J'+str(lnOffset+30)+'#YL0/1/1/30#G'

*- Zone A (Ship from)

lcStringBlock3 = lcStringBlock3 + '#M1/2'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+10)+'#YT108/2///'+'FROM:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+20)+'#YT108/2///'+'NOTATIONS, INC.'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+30)+'#YT108/2///'+'539 JACKSONVILLE RD.'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+40)+'#YT108/2///'+'WARMINSTER, PA 18974'+'#G'
...
IF AT('#',sfsship_name)>0 AND AT('##',sfsship_name)=0 THEN
  ...
  sfsship_name = SUBSTR(sfsship_name,1,lipos-1)+'#'+SUBSTR(sfsship_name,lipos,(LEN(sfsship_name)-lipos)+1)
ENDIF
lcStringBlock3 = lcStringBlock3 + '#T140.0#J'+str(lnOffset+10)+'#YT108/2///'+'TO:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T140.0#J'+str(lnOffset+20)+'#YT108/2///'+alltrim(sfsship_name)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T140.0#J'+str(lnOffset+30)+'#YT108/2///'+alltrim(sfsship_addr1)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T140.0#J'+str(lnOffset+40)+'#YT108/2///'+ ;
	alltrim(sfsship_city)+', '+alltrim(sfsship_state)+'  '+alltrim(sfsship_zip)+'#G'

*- Zone C (Ship to Post [UCC128])

lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+50)+'#YT108/2///'+'BUSINESS UNIT: '+'DB INC.'+'#G'
if (alltrim(division)='3' or alltrim(division)='13' or alltrim(division)='27') then
	lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+60)+'#YT108/2///'+'DIVISION: '+'DRESS BARN WOMAN'+'#G'
else
	lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+60)+'#YT108/2///'+'DIVISION: '+'DRESS BARN'+'#G'
endif
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+70)+'#YT108/2///'+'PO: '+alltrim(po_num)+'#G'
lcStringBlock3=lcStringBlock3+'#T150.0#J'+str(lnOffset+70)+'#YT108/2///'+ ;
	'PRETICKETED: YES'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T80.0#J'+str(lnOffset+10)+'#YT108/2///'+'SIZE: '+lcSizeList+'#G'
lcStringBlock3 = lcStringBlock3 + '#T80.0#J'+str(lnOffset+20)+'#YT108/2///'+'PREPACK: 10 UNITS PER PACK#G'
lcStringBlock3 = lcStringBlock3 + '#T80.0#J'+str(lnOffset+30)+'#YT108/2///'+'COLOR: '+alltrim(lcCustColor)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T80.0#J'+str(lnOffset+40)+'#YT108/2///'+'SKU: '+alltrim(lcSKU_UPC)+'#G'
...
*- Zone G (Mark for store # [UCC128])
lcStringBlock3=lcStringBlock3+'#T80.0#J'+str(lnOffset+70)+'#YT108/2///'+ ;
	'CARTON ________ OF ________'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T80.0#J'+str(lnOffset+50)+'#YT108/2///'+'QUANTITY: '+alltrim(str(lnTotalBlockQty))+'#G'
lcStringBlock3 = lcStringBlock3 + '#T80.0#J'+str(lnOffset+60)+'#YT108/2///'+'PACKS: '+alltrim(str(lnTotalBlockQty/10))+'#G'
lcStringBlock3 = lcStringBlock3 + '#M1/1'
*- Zone H (Mark for store # [text])
