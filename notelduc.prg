...
*- this Foxpro program NOTELDUC.PRG (orig: NOTPCLUC.PRG)
...
*- PART 3: UCC128 part of the label - ELDER BEERMAN & BON-TON (5/16/2005)
*- ----------------------------------------------------------------------------------------------------------------------- -*
...
lcStringBlock2=lcStringBlock2+'#T200.0#J'+str(lnOffset+25+(lnIndLineBlock2*3))+'#YT106/2///'+ ;
	'Ship To: '+ alltrim(lcShipTo) + '#G'
...
lcStringBlock3 = lcStringBlock3 + '#T50.0#J'+str(lnOffset+5)+'#YT101/2///'+'FOR STORE:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T50.0#J'+str(lnOffset+12)+'#YT109/2///'+alltrim(store)+'#G'
