...
DO WHILE NOT EOF('curPart1') 
	...
	*lcStringBlock1=lcStringBlock1+CRLF
	if curPart1.terms=='N01' OR curPart1.terms=='N03' then
		lcStringBlock1 = lcStringBlock1 + '#M2/2#T150.0#J'+str(lnOffset+70)+'#YT109/2///CREDIT CARD#G#M1/1'
	endif
	if curPart1.terms=='COD' then
		lcStringBlock1 = lcStringBlock1 + '#M2/2#T140.0#J'+str(lnOffset+70)+'#YT109/2///C.O.D.#G#M1/1'
	endif
...
lcStringBlock3 = lcStringBlock3 + '#T140.0#J'+STR(lnOffset+70)+'#YT109/2///'+'BARCODE NOT REQUIRED'+'#G'
