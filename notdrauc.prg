...
*- this Foxpro program NOTDRAUC.PRG (orig: NOTPCLUC.PRG)
...
*- PART 3: UCC128 part of the label - ORCHARD BRANDS (Draper) (12/28/2012)
*- ----------------------------------------------------------------------------------------------------------------------- -*
...
lcStringBlock3 = lcStringBlock3 + '#T155.0#J'+STR(lnOffset+6)+'#YT106/2///'+'ORCHARD BRANDS DIST CTR#G'
...
*- Zone D (Carrier, etc.)
IF SUBSTR(po_num,1,2)<>'DD' THEN
  po_num = 'DD'+po_num
ENDIF
lcStringBlock3 = lcStringBlock3 + '#T138.0#J'+str(lnOffset+40)+'#YT108/2///'+'PO: #G'
lcStringBlock3 = lcStringBlock3 + '#T138.0#J'+str(lnOffset+45)+'#YT108/2///'+alltrim(po_num)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T138.0#J'+str(lnOffset+50)+'#YT108/2///'+'Print Date: #G'
lcStringBlock3 = lcStringBlock3 + '#T134.0#J'+str(lnOffset+55)+'#YT108/2///'+DTOC(DATE())+'#G'

*- Zone E (PO / Dept)

liPos = AT('@',lcSKU_UPC)
IF liPos>0 THEN
	lcSKU_UPC = SUBSTR(lcSKU_UPC,1,liPos-1)
ENDIF
if SUBSTR(lcSKU_UPC,1,2)<>'DD' THEN
	lcSKU_UPC = 'DD'+lcSKU_UPC
ENDIF
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+65)+'#YT108/2///'+'Product Number: '+alltrim(lcSKU_UPC)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+72)+'#YT108/2///'+'Color: '+alltrim(cust_color(customer,style,color_code))+'#G'
lcStringBlock3 = lcStringBlock3 + '#T130.0#J'+str(lnOffset+65)+'#YT108/2///'+'Size: '+alltrim(size_desc)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T150.0#J'+str(lnOffset+72)+'#YT108/2///'+'Quantity: '+alltrim(str(lnTotalBlockQty))+'#G'
