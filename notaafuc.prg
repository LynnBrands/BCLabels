...
*- this Foxpro program NOTAAFUC.PRG (orig: NOTPCLUC.PRG)
...
*- PART 3: UCC128 part of the label - AAFES (08/17/10)
*- ----------------------------------------------------------------------------------------------------------------------- -*
...
lcStringBlock3 = lcStringBlock3 + '#T35.0#J'+str(lnOffset+0)+'#YL0/1/1/30#G'
...
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+70)+'#YT108/2///'+'MERCH. TYPE 72#G'

*- Zone F (if not combined with Zone E)

*- Zone G (Mark for store # [UCC128])

&& Store length for AAFES is always 7.
lcStore = ALLTRIM(store)
lcStringBlock3 = lcStringBlock3 + '#T93.0#J'+STR(lnOffset+24)+'#YB15/2O/2.5/5///910'+ALLTRIM(lcStore)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T83.0#J'+STR(lnOffset+28)+'#YT107/2///(910)'+ALLTRIM(lcStore)+'#G'
...
ENDIF
lcStringBlock3 = lcStringBlock3 + '#T30.0#J'+str(lnOffset+10)+'#YT109/2///'+'FAC##'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T30.0#J'+str(lnOffset+18)+'#YT109/2///'+alltrim(store)+'#G'
