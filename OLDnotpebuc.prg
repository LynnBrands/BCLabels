...
*- this Foxpro program NOTPEBUC.PRG (orig: NOTPCLUC.PRG)
...
*- PART 3: UCC128 part of the label - PEEBLES (5/19/2005)
*- ----------------------------------------------------------------------------------------------------------------------- -*
...
lcStringBlock3 = lcStringBlock3 + '#T178.0#J'+str(lnOffset+59)+'#YT107/2///(420)'+alltrim(lcZip)+'#G'
