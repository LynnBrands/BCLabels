...
lcStringBlock3 = lcStringBlock3 + '#T100.0#J'+str(lnOffset+81.3)+'#YL4/2/1/95#G'
lcStringBlock3 = lcStringBlock3 + '#T100.0#J'+str(lnOffset+106.7)+'#YL4/2/1/95#G'
...
lcStringBlock3 = lcStringBlock3 + '#T40.0#J'+str(lnOffset+81.3)+'#YL4/1/1/25.4#G'
...
lcStringBlock3 = lcStringBlock3 + '#T37.0#J'+str(lnOffset+88)+'#YT105/2///'+alltrim(sfsstore_name)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T38.0#J'+STR(lnOffset+91)+'#YT101/2///'+'STORE:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#M2/2#T37.0#J'+str(lnOffset+104)+'#YT108/2///'+alltrim(lcStore)+'#G#M1/1'

*- Zone I (Carton # [UCC128])

lcStringBlock3 = lcStringBlock3 + '#T92.0#J'+str(lnOffset+148)+'#YB15/2O/35.0/6///'+alltrim(carton_num)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T82.0#J'+str(lnOffset+152)+'#YT105/2///'+alltrim(carton_num)+'#G'
