	...
	*- -----------------------------------------------------------------------------------------------
	...
	IF EMPTY(lcSKU_UPC)
		*- zveupcnr.upc_num = char(11)
		lcUPC=vl_upcsr(cur2Temp.Division,'upc_num','',cur2Temp.Style,cur2Temp.Color_code,cur2Temp.lbl_code,'',cur2Temp.Sizebucket)
		lcUPC_chk=vl_upcsr(cur2Temp.Division,'chk_digit','',cur2Temp.Style,cur2Temp.Color_code,cur2Temp.lbl_code,'',cur2Temp.Sizebucket)		
...
*- Fred Meyer requests the 91 barcode in zone C
...
*ENDIF
IF len(ALLTRIM(store))=5
  lcStringBlock3 = lcStringBlock3 + '#T188.0#J'+str(lnOffset+55)+'#YB15/2O/3.5/5///910'+alltrim(store)+'#G'
  lcStringBlock3 = lcStringBlock3 + '#T178.0#J'+str(lnOffset+59)+'#YT107/2///(910)'+alltrim(store)+'#G'
ELSE
  lcStringBlock3 = lcStringBlock3 + '#T188.0#J'+str(lnOffset+55)+'#YB15/2O/3.5/5///91'+alltrim(store)+'#G'
  lcStringBlock3 = lcStringBlock3 + '#T178.0#J'+str(lnOffset+59)+'#YT107/2///(91)'+alltrim(store)+'#G'
ENDIF

*- Zone D (Carrier, etc.)
lcStringBlock3 = lcStringBlock3 + '#M3/3#T127.0#J'+str(lnOffset+50)+'#YT109/2///A#G#M1/1'
lcStringBlock3 = lcStringBlock3 + '#M1/2#T130.0#J'+str(lnOffset+59)+'#YT108/2///'+store+'#G#M1/1'
...
lcStringBlock3=lcStringBlock3+'#T200.0#J'+str(lnOffset+70)+'#YT108/2///'+ ;
