...
??? "#!A1#IMS203.2/76.2#ERN1"   && 8" wide by 9" long "Page"
...
lcStringBlock3 = lcStringBlock3 + '#T100.0#J'+str(lnOffset+10)+'#M2/2#YT108/2///'+'DEPT: '+alltrim(department)+'#G#M1/1'
lcStringBlock3 = lcStringBlock3 + '#T100.0#J'+str(lnOffset+20)+'#M2/2#YT108/2///'+'PO: '+alltrim(po_num)+'#G#M1/1'
lcStringBlock3 = lcStringBlock3 + '#T100.0#J'+STR(lnOffset+25)+'#YT107/2///'+ALLTRIM(style)+'  '+ ;
	ALLTRIM(color_code)+'  '+STR(lnTotal_qty)+' PIECES#G'
