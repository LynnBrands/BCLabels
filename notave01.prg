...
DO WHILE NOT EOF('CurPart2Final') 
	...
	*lcStringBlock2=lcStringBlock2+SPACE(5)
	...
	lcStringBlock2=lcStringBlock2+'#T186.6#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Color'+'#G'
	lcStringBlock2=lcStringBlock2+'#T153.3#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Size'+'#G'
	lcStringBlock2=lcStringBlock2+'#T140.0#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'SKU/UPC'+'#G'
	lcStringBlock2=lcStringBlock2+'#T113.3#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Qty'+'#G'
	*- second column header
	...
	lcStringBlock2=lcStringBlock2+'#T86.6#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Color'+'#G'
	lcStringBlock2=lcStringBlock2+'#T53.3#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Size'+'#G'
	lcStringBlock2=lcStringBlock2+'#T40.0#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'SKU/UPC'+'#G'
	lcStringBlock2=lcStringBlock2+'#T13.3#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Qty'+'#G'
	...
	DO WHILE !eof('curPart2Final') AND lnIndLineBlock2<=MaxNbLineBlock2
		...
		*- Size
		lcStringBlock2=lcStringBlock2+'#T153.3#J'+str(lnOffset+17+(lnIndLineBlock2*3))+'#YT102/2///'+ ;
			padr(size_desc,6)+'#G'
		...
		*- Qty
		lcStringBlock2=lcStringBlock2+'#T113.3#J'+str(lnOffset+17+(lnIndLineBlock2*3))+'#YT102/2///'+ ;
		...
		*- Color - Column 2
		lcColor2 = cust_color(customer,style_col2,color_code_col2)
		lcStringBlock2=lcStringBlock2+'#T86.6#J'+str(lnOffset+17+(lnIndLineBlock2*3))+'#YT102/2///'+ ;
			padr(lcColor2,16)+'#G'

		*- Size - Column 2
		lcStringBlock2=lcStringBlock2+'#T53.3#J'+str(lnOffset+17+(lnIndLineBlock2*3))+'#YT102/2///'+ ;
		...
		*- Qty - Column 2
		lcStringBlock2=lcStringBlock2+'#T13.3#J'+str(lnOffset+17+(lnIndLineBlock2*3))+'#YT102/2///'+ ;
...
lcStringBlock3 = lcStringBlock3 + '#M2/2#T80.0#J'+str(lnOffset+12)+'#YT108/2///##'+ALLTRIM(store)+' '+ ;
    alltrim(lcStoreName)+'#G#M1/1'
IF lnBucketsUsed>1 THEN 
		...
		for lnIndbucket=2 to 9
			if explarr[lnIndbucket] > 0 then
				...
				lcStringBlock3=lcStringBlock3+ ;
					'#T'+str(80-((lnIndbucket-2)*10))+'#J'+str(lnOffset+20)+'#YT103/2///'+ ;
					alltrim(str(explarr[lnIndbucket]))+'#G'
			endif
		endfor
		lcStringBlock3 = lcStringBlock3 + '#T100.0#J'+str(lnOffset+25)+'#YT103/2///PACK QTY: '+str(explarr[1])+'#G'
		lcStringBlock3 = lcStringBlock3 + '#T40.0#J'+str(lnOffset+25)+'#YT103/2///'+'QTY: '+alltrim(str(lnTotalBlockQty/explarr[1]))+'#G'
	endif
ELSE
	lcStringBlock3 = lcStringBlock3 + '#T95.0#J'+str(lnOffset+20)+'#YT105/2///'+'PROD:'+'#G'
	lcStringBlock3 = lcStringBlock3 + '#T80.0#J'+str(lnOffset+20)+'#YT108/2///'+alltrim(lcDeptName)+'#G'
ENDIF
