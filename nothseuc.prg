...
*- this Foxpro program NOTSEAUC.PRG (orig: NOTPCLUC.PRG)
...
*- PART 3: UCC128 part of the label - Sears Holding Corp. (01/10/2008)
*- ----------------------------------------------------------------------------------------------------------------------- -*
...
??? "#!A1#IMS203.2/158.7#ERN1"   && 8" wide by 9" long "Page"
...
lcStringBlock3 = lcStringBlock3 + '#T190.0#J'+str(lnOffset+8)+'#YT102/2///Artikel-Nr.#G'
lcStringBlock3 = lcStringBlock3 + '#T190.0#J'+str(lnOffset+8)+'#YT102/2///_________#G'
lcStringBlock3 = lcStringBlock3 + '#T133.0#J'+str(lnOffset+13)+'#YT108/2///'+alltrim(lcSKU_UPC)+'#G'

*- Line 2: Store name, Casepack, Barcode
lcStringBlock3 = lcStringBlock3 + '#T190.0#J'+str(lnOffset+16)+'#YT105/2///HSE 24#G'
lcStringBlock3 = lcStringBlock3 + '#T190.0#J'+str(lnOffset+22)+'#YT102/2///Menge#G'
lcStringBlock3 = lcStringBlock3 + '#T190.0#J'+str(lnOffset+22)+'#YT102/2///______#G'
lcStringBlock3 = lcStringBlock3 + '#T190.0#J'+str(lnOffset+35)+'#YT108/2///'+alltrim(str(lnTotalBlockQty))+'#G'

*- Line 3: Carton X/Y

*- Line 4: Article description
lcStringBlock3 = lcStringBlock3 + '#T190.0#J'+str(lnOffset+52)+'#YT102/2///Artikelbezeichnung#G'
lcStringBlock3 = lcStringBlock3 + '#T133.0#J'+str(lnOffset+52)+'#YT108/2///TONI BRATTIN PONCHO#G'

*- Line 5: Supplier #
lcStringBlock3 = lcStringBlock3 + '#T190.0#J'+str(lnOffset+66)+'#YT102/2///Lieferantennummer#G'
lcStringBlock3 = lcStringBlock3 + '#T133.0#J'+str(lnOffset+66)+'#YT108/2///108725#G'



*- End

lcStringBlock3 = lcStringBlock3 + '#M1/1#Q1#G'
??? lcStringBlock3
