...
lcStringBlock3 = lcStringBlock3 + '#T203.2#J'+str(lnOffset+22)+'#YL0/2/1/101.6#G'
lcStringBlock3 = lcStringBlock3 + '#T203.2#J'+str(lnOffset+47)+'#YL0/2/1/101.6#G'
lcStringBlock3 = lcStringBlock3 + '#T159.3#J'+str(lnOffset+0)+'#YL0/1/1/22#G'
lcStringBlock3 = lcStringBlock3 + '#T86.0#J'+str(lnOffset+0)+'#YL0/1/1/25#G'
lcStringBlock3 = lcStringBlock3 + '#T140.1#J'+str(lnOffset+22)+'#YL0/1/1/25#G'
...
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+12)+'#YT102/2///'+'WARMINSTER, PA 18974 US'+'#G'
...
lcStringBlock3 = lcStringBlock3 + '#T155.0#J'+str(lnOffset+18)+'#YT106/2///'+B_CSZ+' US#G'

*- Zone C (Ship to Post [UCC128])

lcStringBlock3 = lcStringBlock3 + '#T188.0#J'+str(lnOffset+43)+'#YB15/2O/3.5/5///420'+alltrim(sfsship_zip)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T178.0#J'+str(lnOffset+47)+'#YT107/2///(420)'+alltrim(sfsship_zip)+'#G'

*- Zone D (Carrier, etc.)
lcStringBlock3 = lcStringBlock3 + '#T138.0#J'+str(lnOffset+27)+'#YT102/2///Carrier:#G'
lcStringBlock3 = lcStringBlock3 + '#T138.0#J'+str(lnOffset+37)+'#YT102/2///BOL:#G'

*- Zone E (PO / Dept)

lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+55)+'#YT108/2///'+'PO: '+alltrim(po_num)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T150.0#J'+str(lnOffset+55)+'#YT108/2///'+'Chain: '+alltrim(department)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T120.0#J'+str(lnOffset+55)+'#YT108/2///'+'Mode: '+alltrim(department)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+60)+'#YT108/2///'+'MSN ##: '+alltrim(department)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+65)+'#YT108/2///'+'Total Qty: '+alltrim(department)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T150.0#J'+str(lnOffset+65)+'#YT108/2///'+'Carton _______ of _______#G'

*- Zone F (if not combined with Zone E)

*- Zone G (Mark for store # [UCC128])

lcStore = ALLTRIM(center_code)
IF LEN(lcStore)=5 then
  lcStore = substr(lcStore,2,4)
ENDIF
lcStringBlock3 = lcStringBlock3 + '#T93.0#J'+STR(lnOffset+20)+'#YB15/2O/2.5/5///910'+ALLTRIM(lcStore)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T83.0#J'+STR(lnOffset+24)+'#YT107/2///(910)'+ALLTRIM(lcStore)+'#G'
...
ENDIF
lcStringBlock3 = lcStringBlock3 + '#T85.0#J'+str(lnOffset+3)+'#YT102/2///'+'FOR:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T84.0#J'+str(lnOffset+8)+'#YT108/2///'+alltrim(sfscust_name)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T84.0#J'+STR(lnOffset+12)+'#YT108/2///ST##'+ALLTRIM(store)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T84.0#J'+STR(lnOffset+16)+'#YT108/2///'+ALLTRIM(sfsstore_name)+'#G'
...
lcStringBlock3 = lcStringBlock3 + '#T84.0#J'+STR(lnOffset+24)+'#YT109/2///'+ALLTRIM(lcFOB)+'#G'
