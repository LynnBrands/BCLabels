...
*brow title alias()
	...
	*lcStringBlock2=lcStringBlock2+SPACE(5)
	lcStringBlock2=lcStringBlock2+'#T200.0#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Vendor Style'+'#G'
	lcStringBlock2=lcStringBlock2+'#T160.6#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Color'+'#G'
	lcStringBlock2=lcStringBlock2+'#T130.3#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Size'+'#G'
	lcStringBlock2=lcStringBlock2+'#T110.0#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Item Number'+'#G'
	lcStringBlock2=lcStringBlock2+'#T40.3#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Qty'+'#G'
	...
	lnLineNum = 1
		...
		*- Style
		lcStringBlock2=lcStringBlock2+'#T200.0#J'+str(lnOffset+17+(lnIndLineBlock2*8))+'#YT109/2///'+ ;
			padr(style,10)+'#G'
		
		*- Color
		lcStringBlock2=lcStringBlock2+'#T160.6#J'+str(lnOffset+17+(lnIndLineBlock2*8))+'#YT109/2///'+ ;
			padr(color_code,6)+'#G'

		*- Size
		lcStringBlock2=lcStringBlock2+'#T130.3#J'+str(lnOffset+17+(lnIndLineBlock2*8))+'#YT109/2///'+ ;
			padr(size_desc,6)+'#G'

		*- SKU/UPC
                if len(SKU_UPC) > 8 then
                   lcSKU_UPC = substr(SKU_UPC,1,4)+'-'+substr(SKU_UPC,5,4)+'  '+substr(SKU_UPC,9)
                endif
		lcStringBlock2=lcStringBlock2+'#T110.0#J'+str(lnOffset+17+(lnIndLineBlock2*8))+'#YT109/2///'+ ;
			padr(lcSKU_UPC,12)+'#G'
		
		*- Qty
		lcStringBlock2=lcStringBlock2+'#T60.3#J'+str(lnOffset+17+(lnIndLineBlock2*8))+'#YT109/2///'+ ;
...
lcStringBlock3 = lcStringBlock3 + '#T165.0#J'+str(lnOffset+9)+'#YT107/2///'+alltrim(sfsship_name)+' ('+alltrim(center_code)+')#G'
