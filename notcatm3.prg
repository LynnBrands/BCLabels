...
*- this Foxpro program NOTCATM4.PRG (orig: NOTPCLUC.PRG)
...
ORDER BY carton_num,size_code,style,line_seq
...
scan
	...
	*- Fill size quantities fields siz01_qty,..,siz10_qty	
	*- --------------------------------------------------
	select curOneSKU
	scan
...
??? "#!A1#IMS203.2/158.0#ERN1"   && 8" wide by 9" long "Page"
...
if liBadSku = 0 then
	*lcStringBlock1=lcStringBlock1+SPACE(5)
	lcStringBlock1=lcStringBlock1+'#T200.0#J'+str(lnOffset+22+(lnIndLineBlock1*4))+'#YT103/2///'+'LN'+'#G'
lcStringBlock1=lcStringBlock1+'#T190.0#J'+str(lnOffset+22+(lnIndLineBlock1*4))+'#YT103/2///'+'STYLE'+'#G'
	lcStringBlock1=lcStringBlock1+'#T160.0#J'+str(lnOffset+22+(lnIndLineBlock1*4))+'#YT103/2///'+'COLOR'+'#G'
	lcStringBlock1=lcStringBlock1+'#T135.0#J'+str(lnOffset+22+(lnIndLineBlock1*4))+'#YT103/2///'+'DEPT'+'#G'
else
        lcStringBlock1=lcStringBlock1+'#T200.0#J'+str(lnOffset+22+(lnIndLineBlock1*4))+'#YT105/2///'+ ;
	...
	*- Maximum 9 size headers
	...
	if (curPart1.siz10_qty>0) then
		lcStringBlock1=lcStringBlock1+ ;
			'#T40.0#J'+str(lnOffset+22+(lnIndLineBlock1*4))+'#YT103/2///'+ ;
			padl(curPart1.siz10_head,7)+'#G'
		lcStringBlock1=lcStringBlock1+ ;
			'#T40.0#J'+str(lnOffset+22+(lnIndLineBlock1*4))+'#YT103/2///_____#G'
	endif
	lcStringBlock1=lcStringBlock1+'#M2/3'
	*- Total
	...
	DO WHILE !eof('curPart1') AND lnIndLineBlock1<=MaxNbLineBlock2
		...
		*--- Bruno DIEPENDAELE -> Mike Sabal = This is a new block of code. Please check the printer control characters
		IF curPart1.size_code<>lcCurSize_code
			...
			*- Maximum 9 size headers
			...
			if (curPart1.siz10_qty>0) then
				lcStringBlock1=lcStringBlock1+ ;
					'#T40.0#J'+str(lnOffset+21+(lnIndLineBlock1*4))+'#YT102/2///'+ ;
					padl(curPart1.siz10_head,7)+'#G'
				lcStringBlock1=lcStringBlock1+ ;
					'#T40.0#J'+str(lnOffset+21+(lnIndLineBlock1*4))+'#YT102/2///_____#G'
			endif
			lcStringBlock1=lcStringBlock1+'#M2/3'
		...
		*- Style
		lcStringBlock1=lcStringBlock1+'#T190.0#J'+str(lnOffset+21+(lnIndLineBlock1*4))+'#YT103/2///'+ ;
			padr(style,10)+'#G'
		
		*- Color
                lcColorCode = color_code
                liAtSignPos = at('@',lcColorCode)
                if liAtSignPos > 0 then
                  lcColorCode = substr(lcColorCode,1,liAtSignPos-1)
                endif
		lcStringBlock1=lcStringBlock1+'#T160.0#J'+str(lnOffset+21+(lnIndLineBlock1*4))+'#YT103/2///'+ ;
			lcColorCode+'#G'

		*- Department
		lcStringBlock1=lcStringBlock1+'#T135.0#J'+str(lnOffset+21+(lnIndLineBlock1*4))+'#YT103/2///'+ ;
			padr(department,6)+'#G'
...
if alltrim(lcCust)='MONTE' then
  lcStringBlock1=lcStringBlock1+'#T95.0#J'+str(lnOffset+68)+'#YT106/2///CARTON _____ OF ______     WEIGHT: _______#G'
endif
