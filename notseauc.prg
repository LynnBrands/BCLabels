...
*- Sears, Inc. - JIT and Direct-to-Store
...
lcStringBlock3 = lcStringBlock3 + '#T137.0#J'+str(lnOffset+40)+'#YT107/2///'+'P.O. NUMBER: '+'#G'
lcStringBlock3 = lcStringBlock3 + '#T137.0#J'+str(lnOffset+47)+'#YT108/2///'+substr(po_num,1,5)+ ;
    '-'+alltrim(substr(po_num,6))+'#G'

*- Zone E/F (Not used by Sears)

*- Zone G (Not used by Sears)
...
&& Sears requires the store number to be at least 0.75 inches in height.
...
ENDIF
lcStringBlock3 = lcStringBlock3 + '#T50.0#J'+str(lnOffset+7)+'#YT105/2///'+'STORE NUMBER:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#M2/4#T50.0#J'+str(lnOffset+27)+'#YT108/2///'+alltrim(store)+'#G#M1/1'

*- Zone I (Carton # [UCC128])

lcStringBlock3 = lcStringBlock3 + '#T93.0#J'+str(lnOffset+64)+'#YB15/2O/5.5/5///'+alltrim(carton_num)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T93.0#J'+str(lnOffset+69)+'#YT108/2///('+substr(carton_num,1,2)+ ;
