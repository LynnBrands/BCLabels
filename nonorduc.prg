...
DO WHILE NOT EOF('curPart1') 
	...
	*- Header line 1
	lcStringBlock1=lcStringBlock1+'#T138.0#J05.0#YT107/2///'+'Carton Pick Slip (Internal)'+'#G'
	...
	*lcStringBlock1=lcStringBlock1+SPACE(5)
	...
	lcStringBlock1=lcStringBlock1+'#T66.6#J'+str(lnOffset+8)+'#YT103/2///'+'Order ##:'+'#G'
...
DO WHILE NOT EOF('CurPart2Final') 
	...
	*lcStringBlock2=lcStringBlock2+SPACE(5)
	...
	lcStringBlock2=lcStringBlock2+'#T165.0#J'+str(lnOffset+4)+'#YT103/2///'+'Wave number:'+'#G'
        if wave_num > 0 then
  	  lcStringBlock2=lcStringBlock2+'#T150.0#J'+str(lnOffset+4)+'#YT103/2///'+str(wave_num)+'#G'
        else
  	  lcStringBlock2=lcStringBlock2+'#T150.0#J'+str(lnOffset+4)+'#YT103/2///'+allt(carton_udf2)+'#G'
        endif
	...
	lcStringBlock2=lcStringBlock2+'#T66.6#J'+str(lnOffset+4)+'#YT102/2///'+ ;
		'Order ##: '+left(allt(str(ord_num)),15)+'#G'
...
lcStringBlock3 = lcStringBlock3 + '#T188.0#J'+str(lnOffset+55)+'#YB15/2O/3.5/5///420'+alltrim(lcZip)+'#G'
...
ENDIF
lcStringBlock3 = lcStringBlock3 + '#T50.0#J'+str(lnOffset+14)+'#YT105/2///'+'STORE NUMBER:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#M1/2#T50.0#J'+str(lnOffset+27)+'#YT109/2///'+alltrim(store)+'#G#M1/1'
