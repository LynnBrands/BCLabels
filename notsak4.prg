...
*- Zone E (PO / Dept)
lcGroup = vl_groupcode(ord_num)
lcStringBlock3 = lcStringBlock3 + '#T98.0#J'+str(lnOffset+57)+'#YT108/2///'+'PO: '+alltrim(po_num)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T98.0#J'+str(lnOffset+67)+'#YT108/2///'+'Dept: '+alltrim(department)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T48.0#J'+str(lnOffset+57)+'#YT108/2///'+'Qty: '+alltrim(str(lnTotalBlockQty))+'#G'
lcStringBlock3 = lcStringBlock3 + '#T48.0#J'+str(lnOffset+67)+'#YT108/2///'+'Grp: '+alltrim(lcGroup)+'#G'
...
ENDIF
lcStringBlock3 = lcStringBlock3 + '#T93.0#J'+STR(lnOffset+89)+'#YB15/2O/12.5/5///910'+ALLTRIM(lcStore)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T83.0#J'+STR(lnOffset+93)+'#YT105/2///(91)0'+ALLTRIM(lcStore)+'#G'
...
ENDIF
lcStringBlock3 = lcStringBlock3 + '#T38.0#J'+str(lnOffset+74)+'#YT101/2///'+'FOR:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T37.0#J'+str(lnOffset+78)+'#YT105/2///'+alltrim(sfsstore_name)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T38.0#J'+STR(lnOffset+81)+'#YT101/2///'+'STORE:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#M2/2#T37.0#J'+str(lnOffset+94)+'#YT108/2///'+alltrim(lcStore)+'#G#M1/1'
...
*-----------------------------------------------------------------------------
*- FUNCTION vl_groupcode(ord_num,line_seq)
*- Returns REF/PG from zzedatawhse
*- Michael J. Sabal, Notations, Inc. 28 June 2010
*-----------------------------------------------------------------------------
FUNCTION vl_groupcode
PARAMETERS parm_ordnum
