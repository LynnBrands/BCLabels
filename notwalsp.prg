...
lcStringBlock2 = lcStringBlock2 + '#T93.0#J'+str(lnOffset+70)+'#YB15/2M/3/6///'+lcSumCartonNum+'#G'
...
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+74)+'#YT108/2///WMIT: '+alltrim(lcWMIT)+'#G'
...
lcStringBlock4 = lcStringBlock4 + '#T95.0#J'+str(lnOffset+8)+'#YT108/2///'+alltrim(style)+'#G'
lcStringBlock4 = lcStringBlock4 + '#T30.0#J'+str(lnOffset+8)+'#YT108/2///'+alltrim(str(lnTotalBlockQty))+' pcs#G'
lcStringBlock4 = lcStringBlock4 + '#T50.0#J'+str(lnOffset+16)+'#YT108/2M///'+alltrim(sfcstylename)+'#G'
lcStringBlock4 = lcStringBlock4 + '#T95.0#J'+str(lnOffset+24)+'#YT108/2///'+alltrim(color_code)+'#G'
if isPPK = .F.
	lcStringBlock4 = lcStringBlock4 + '#T30.0#J'+str(lnOffset+24)+'#YT108/2///'+alltrim(size_desc)+'#G'
endif

*- Zone I (Carton # [SSCC-14])

&& Interleaved 2 of 5
lcStringBlock4 = lcStringBlock4 + '#T91.0#J'+str(lnOffset+64)+'#YB12/2O/5/7///'+alltrim(lcSSCC14)+'#G'
lcStringBlock4 = lcStringBlock4 + '#T80.0#J'+str(lnOffset+69)+'#YT108/2///'+substr(lcSSCC14,1,1)+' '+ ;
  substr(lcSSCC14,2,2)+' '+substr(lcSSCC14,4,5)+' '+substr(lcSSCC14,9,5)+' '+ ;
  substr(lcSSCC14,14,1)+'#G'
lcStringBlock4 = lcStringBlock4 + '#T95.0#J'+str(lnOffset+64)+'#YL0/2/1/81.0#G'
lcStringBlock4 = lcStringBlock4 + '#T95.0#J'+str(lnOffset+35)+'#YL0/2/1/81.0#G'
