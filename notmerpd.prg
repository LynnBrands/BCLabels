...
*- this Foxpro program NOTMERPD.PRG (orig: NOTPCLUC.PRG)
...
*- MERVYNS PRE-DISTRO (ship to store via DC)
lnPageNum = lnPageNum + 1
lnOffset = (lnPageNum - 1) * 79
lcStringBlock3 = ''
...
lcStringBlock3 = lcStringBlock3 + '#T60.0#J'+str(lnOffset+0)+'#YL0/1/1/30#G'
...
* lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+66)+'#YT108/2///'+'DPCI: '+alltrim(SKU_UPC)+'#G'
* lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+70)+'#YT108/2///'+'CASEPACK: 12#G'
...
lcStringBlock3 = lcStringBlock3 + '#T55.0#J'+str(lnOffset+4)+'#YT105/2///'+'FOR MERVYNS STORE:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#M2/2#T40.0#J'+str(lnOffset+18)+'#YT109/2///'+alltrim(store)+'#G#M1/1'
