...
*brow title alias()
	...
	*- Header line 3 = style data
	lcStringBlock2=lcStringBlock2+'#T200.0#J'+str(lnOffset+12)+'#YT104/2///'+ ;
		'Style: '+left(style,10)+'#G'
	lcStringBlock2=lcStringBlock2+'#T150.0#J'+str(lnOffset+12)+'#YT104/2///'+ ;
		'Color: '+left(color_code,6)+'#G'
	lcStringBlock2=lcStringBlock2+'#T125.0#J'+str(lnOffset+20)+'#YT109/2///'+ ;
		'MASTERCARTON'+'#G'

	*- Header line 4 = pack size breakdown
	lcStringBlock2=lcStringBlock2+'#T180.0#J'+str(lnOffset+30)+'#YT107/2///'+ ;
		'PACK SIZE BREAKDOWN:'+'#G'
	lcStringBlock2=lcStringBlock2+'#T120.0#J'+str(lnOffset+27)+'#YT106/2///'+ ;
		'4P   6P   8P  10P  12P  14P  16P'+'#G'
	lcStringBlock2=lcStringBlock2+'#T120.0#J'+str(lnOffset+30)+'#YT106/2///'+ ;
		' 1     1     1     2      1      1      1'+'#G'
	lcStringBlock2=lcStringBlock2+'#T166.0#J'+str(lnOffset+55)+'#YT109/2///'+ ;
		'Number of innerpacks per carton: '+allt(str(lnTotalBlockQty/8))+'#G'
...
lcStringBlock3 = lcStringBlock3 + '#T42.0#J'+str(lnOffset+9)+'#YT109/2///'+alltrim(store)+'#G'
