...
*- this Foxpro program NOTPAMUC.PRG (orig: NOTPCLUC.PRG)
...
*- PART 3: UCC128 part of the label - PAMIDA (04/30/07)
*- ----------------------------------------------------------------------------------------------------------------------- -*
...
scan
	...
	*- -----------------------------------------------------------------------------------------------
    ...
    lcRangeStyle = vl_rangestyle(cur2Temp.ord_num,cur2Temp.pick_num,cur2Temp.Style,cur2Temp.color_code,cur2Temp.lbl_code)
	...
	IF EMPTY(lcSKU_UPC)
		*- zveupcnr.upc_num = char(11)
		...
		lcSKU_UPC=allt(lcUPC)+allt(lcUPC_chk)
                liBadSku = 1
	ENDIF
	IF EMPTY(lcRangeStyle)
		lcRangeStyle = lcSKU_UPC
	ENDIF
...
if liBadSku = 0
	*lcStringBlock2=lcStringBlock2+SPACE(5)
	...
	lcStringBlock2=lcStringBlock2+'#T50.0#J'+str(lnOffset+14)+'#YT102/2///'+ ;
        ...
        lcStringBlock2=lcStringBlock2+'#T200.0#J'+str(lnOffset+14)+'#YT105/2///'+ ;
...
lcStringBlock3 = lcStringBlock3 + '#T177.0#J'+str(lnOffset+59)+'#YT107/2///(420)'+alltrim(sfsship_zip)+'#G'
...
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+69)+'#YT108/2///'+'DEPT: '+alltrim(department)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+73)+'#YT108/2///'+'PRETICKETED AND PREHUNG'+'#G'
if alltrim(customer)="SHOPKO" and LEN(alltrim(lcRangeStyle))>0 then
  lcStringBlock3 = lcStringBlock3 + '#T150.0#J'+str(lnOffset+65)+'#YT108/2///'+'SKU: '+lcRangeStyle+'#G'
endif
...
lcStringBlock3 = lcStringBlock3 + '#M3/3'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J30.0#YT109/2///CUSTOMER SKU MISSING#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J60.0#YT109/2///MUST REPRINT BEFORE USING#G'
...
PARAMETERS parm_ordnum, parm_picknum, parm_style, parm_color, parm_label
  ...
  lcSQLQuery = "SELECT rng_style FROM zzoordrd WHERE ord_num="+alltrim(str(parm_ordnum))+;
