...
??? "#!A1#IMS101.6/155.0#ERN1"	 && 4" wide by 6" long "Page"
...
lnPageNum = 0 && Temporary
*- CHARMING SHOPPES 4x6
...
*- Draw lines
*- Horizontal
lcStringBlock3 = lcStringBlock3 + '#T101.0#J'+str(lnOffset+20.3)+'#YL0/2/1/101#G'
lcStringBlock3 = lcStringBlock3 + '#T101.0#J'+str(lnOffset+45.7)+'#YL0/2/1/101#G'
lcStringBlock3 = lcStringBlock3 + '#T101.0#J'+str(lnOffset+81.3)+'#YL0/2/1/101#G'
lcStringBlock3 = lcStringBlock3 + '#T101.0#J'+str(lnOffset+106.7)+'#YL0/2/1/101#G'

*- Vertical
lcStringBlock3 = lcStringBlock3 + '#T63.5#J'+str(lnOffset+0)+'#YL0/1/1/20#G'
lcStringBlock3 = lcStringBlock3 + '#T38.1#J'+str(lnOffset+20.3)+'#YL0/1/1/25.4#G'
lcStringBlock3 = lcStringBlock3 + '#T40.0#J'+str(lnOffset+81.3)+'#YL0/1/1/25.4#G'

*- Zone A (Ship from)

lcStringBlock3 = lcStringBlock3 + '#T100.0#J'+str(lnOffset+3)+'#YT105/2///'+'FROM:'+'#G'
...
lcStringBlock3 = lcStringBlock3 + '#T58.0#J'+str(lnOffset+3)+'#YT105/2///'+'TO:'+'#G'
...
lcStringBlock3 = lcStringBlock3 + '#T55.0#J'+str(lnOffset+18)+'#YT105/2///'+B_CSZ+' US#G'

*- Zone C (Ship to Post [UCC128])

lcStringBlock3 = lcStringBlock3 + '#T88.0#J'+str(lnOffset+40)+'#YB15/2O/15/5///420'+alltrim(sfsship_zip)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T79.0#J'+str(lnOffset+44)+'#YT105/2///(420)'+alltrim(sfsship_zip)+'#G'
...
*- Zone E (PO / Dept)
lcMSN = vl_msnnum(pick_num,line_seq)
lcMode = vl_pidmode(ord_num,line_seq)
lcStringBlock3 = lcStringBlock3 + '#T98.0#J'+str(lnOffset+55)+'#YT108/2///'+'PO: '+alltrim(po_num)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T56.0#J'+str(lnOffset+55)+'#YT105/2///'+'Chain: '+alltrim(department)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T38.0#J'+str(lnOffset+55)+'#YT105/2///D#G'
lcStringBlock3 = lcStringBlock3 + '#T30.0#J'+str(lnOffset+55)+'#YT108/2///'+'Mode: '+alltrim(lcMode)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T98.0#J'+str(lnOffset+65)+'#YT108/2///'+'MSN ##: '+lcMSN+'#G'
lcBulkPrepackText = ''
IF lnItemCount = 1 THEN
	lcBulkPrepackText = 'BULK'
ELSE
	lcBulkPrepackText = 'PREPACK'
ENDIF
lcStringBlock3 = lcStringBlock3 + '#T30.0#J'+str(lnOffset+65)+'#YT108/2///'+lcBulkPrepackText+'#G'
lcStringBlock3 = lcStringBlock3 + '#T98.0#J'+str(lnOffset+75)+'#YT105/2///'+'Total Qty: '+alltrim(str(lnTotalBlockQty))+'#G'
lcStringBlock3 = lcStringBlock3 + '#T60.0#J'+str(lnOffset+75)+'#YT105/2///'+'Carton ____ of ____#G'
...
ENDIF
lcStringBlock3 = lcStringBlock3 + '#T93.0#J'+STR(lnOffset+99)+'#YB15/2O/12.5/5///910'+ALLTRIM(lcStore)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T83.0#J'+STR(lnOffset+103)+'#YT105/2///(91)0'+ALLTRIM(lcStore)+'#G'
...
ENDIF
lcStringBlock3 = lcStringBlock3 + '#T38.0#J'+str(lnOffset+84)+'#YT101/2///'+'FOR:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T37.0#J'+str(lnOffset+88)+'#YT105/2///'+alltrim(B_NAME)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T37.0#J'+STR(lnOffset+97)+'#YT108/2///'+ALLTRIM(center_code)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T37.0#J'+STR(lnOffset+102)+'#YT105/2///'+ALLTRIM(B_CSZ)+'#G'

*- Zone I (Carton # [UCC128])

lcStringBlock3 = lcStringBlock3 + '#T93.0#J'+str(lnOffset+146)+'#YB15/2O/27.5/6///'+alltrim(carton_num)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T84.0#J'+str(lnOffset+150)+'#YT105/2///'+alltrim(carton_num)+'#G'
