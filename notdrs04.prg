...
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+55)+'#YT108/2///'+'PREPACK: 4 UNITS PER PACK#G'
...
lcStringBlock3 = lcStringBlock3 + '#T100.0#J'+str(lnOffset+28)+'#YT109/2///'+'PACKS: '+alltrim(str(lnTotalBlockQty/4))+'#G'
...
lcStringBlock3 = lcStringBlock3 + '#T80.0#J'+str(lnOffset+20)+'#YT108/2///'+'PREPACK: 4 UNITS PER PACK#G'
...
lcStringBlock3 = lcStringBlock3 + '#T80.0#J'+str(lnOffset+60)+'#YT108/2///'+'PACKS: '+alltrim(str(lnTotalBlockQty/4))+'#G'
