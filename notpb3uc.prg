...
*- --------------------------------------------------------------------------------
SELECT *,style as style_col2,color_code as color_code_col2,size_desc as size_desc_col2,SKU_UPC as SKU_UPC_col2, ;
sfscolor_name as color_name2,total_qty as total_qty_col2 ; 
FROM CurPart2 ;
where .F. ; 
...
SCAN
	...
	if MOD(lnRecordPointCurPart2,2*MaxNbLineBlock2)<=MaxNbLineBlock2 AND MOD(lnRecordPointCurPart2,2*MaxNbLineBlock2)>0
		*- Insert a new record in CurPart2Final
		...
		replace color_name2 with CurPart2.sfscolor_name in CurPart2Final
...
DO WHILE NOT EOF('CurPart2Final') 
	...
	*lcStringBlock2=lcStringBlock2+SPACE(5)
	...
	lcStringBlock2=lcStringBlock2+'#T186.6#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Color'+'#G'
	lcStringBlock2=lcStringBlock2+'#T158.0#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Size'+'#G'
	lcStringBlock2=lcStringBlock2+'#T150.0#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'SKU/UPC'+'#G'
	lcStringBlock2=lcStringBlock2+'#T125.3#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Qty'+'#G'
	*- second column header
	...
	lcStringBlock2=lcStringBlock2+'#T86.6#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Color'+'#G'
	lcStringBlock2=lcStringBlock2+'#T58.0#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Size'+'#G'
	lcStringBlock2=lcStringBlock2+'#T50.0#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'SKU/UPC'+'#G'
	lcStringBlock2=lcStringBlock2+'#T25.3#J'+str(lnOffset+14)+'#YT102/2///'+ ;
		'Qty'+'#G'
	...
	DO WHILE !eof('curPart2Final') AND lnIndLineBlock2<=MaxNbLineBlock2
		...
		*- Color
		lcStringBlock2=lcStringBlock2+'#T186.6#J'+str(lnOffset+17+(lnIndLineBlock2*3))+'#YT102/2///'+ ;
			alltrim(sfscolor_name)+'#G'
*			padr(color_code,6)+'#G'

		*- Size
		lcStringBlock2=lcStringBlock2+'#T158.0#J'+str(lnOffset+17+(lnIndLineBlock2*3))+'#YT102/2///'+ ;
			padr(size_desc,6)+'#G'

		*- SKU/UPC
		lcStringBlock2=lcStringBlock2+'#T150.0#J'+str(lnOffset+17+(lnIndLineBlock2*3))+'#YT102/2///'+ ;
			padr(SKU_UPC,12)+'#G'
		
		*- Qty
		lcStringBlock2=lcStringBlock2+'#T125.3#J'+str(lnOffset+17+(lnIndLineBlock2*3))+'#YT102/2///'+ ;
		...
		*- Color - Column 2
		lcStringBlock2=lcStringBlock2+'#T86.6#J'+str(lnOffset+17+(lnIndLineBlock2*3))+'#YT102/2///'+ ;
			alltrim(color_name2)+'#G'
*			padr(color_code_col2,6)+'#G'

		*- Size - Column 2
		lcStringBlock2=lcStringBlock2+'#T58.0#J'+str(lnOffset+17+(lnIndLineBlock2*3))+'#YT102/2///'+ ;
			padr(size_desc_col2,6)+'#G'

		*- SKU/UPC - Column 2
		lcStringBlock2=lcStringBlock2+'#T50.0#J'+str(lnOffset+17+(lnIndLineBlock2*3))+'#YT102/2///'+ ;
			padr(SKU_UPC_col2,12)+'#G'
		
		*- Qty - Column 2
		lcStringBlock2=lcStringBlock2+'#T25.3#J'+str(lnOffset+17+(lnIndLineBlock2*3))+'#YT102/2///'+ ;
			padr(str(total_qty_col2,6),6)+'#G'
		if total_qty_col2 > 0 then
		  lnSKUCount = lnSKUCount + 1
		endif
...
lnOffset = (lnPageNum - 1) * 79
lcStringBlock3 = ''
if lnPageNum=1 and alltrim(location)=='WTPE' then
  && lnOffset = lnOffset + 2
endif
...
lcStringBlock3 = lcStringBlock3 + '#T203.2#J'+str(lnOffset+26)+'#YL0/2/1/101.6#G'
lcStringBlock3 = lcStringBlock3 + '#T203.2#J'+str(lnOffset+52)+'#YL0/2/1/101.6#G'
lcStringBlock3 = lcStringBlock3 + '#T168.3#J'+str(lnOffset+0)+'#YL0/1/1/26#G'
lcStringBlock3 = lcStringBlock3 + '#T139.7#J'+str(lnOffset+26)+'#YL0/1/1/26#G'
...
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+3)+'#YT106/2///'+'FROM:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+7)+'#YT103/2///'+'NOTATIONS, INC.'+'#G'
IF alltrim(location)=='WPAFG' THEN
  lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+10)+'#YT103/2///'+'539 JACKSONVILLE RD.'+'#G'
  lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+13)+'#YT103/2///'+'WARMINSTER, PA'+'#G'
  lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+16)+'#YT103/2///'+'              18974'+'#G'
ELSE IF alltrim(location)=='WTPE' THEN
  lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+10)+'#YT103/2///'+'15530 SALT LAKE AVE.'+'#G'
  lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+13)+'#YT103/2///'+'CITY OF INDUSTRY, CA'+'#G'
  lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+16)+'#YT103/2///'+'              91745'+'#G'
ENDIF
...
ENDIF
lcStringBlock3 = lcStringBlock3 + '#T167.0#J'+str(lnOffset+3)+'#YT107/2///'+'TO:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T165.0#J'+str(lnOffset+9)+'#YT107/2///'+alltrim(sfsship_name)+'#G'
...
IF len(ALLTRIM(sfsship_zip))>5
  lcStringBlock3 = lcStringBlock3 + '#T188.0#J'+str(lnOffset+46)+'#YB15/2O/2.5/5///420'+substr(sfsship_zip,1,5)+'#G'
  lcStringBlock3 = lcStringBlock3 + '#T178.0#J'+str(lnOffset+50)+'#YT107/2///(420)'+substr(sfsship_zip,1,5)+'#G'
ELSE
  lcStringBlock3 = lcStringBlock3 + '#T188.0#J'+str(lnOffset+46)+'#YB15/2O/2.5/5///420'+alltrim(sfsship_zip)+'#G'
  lcStringBlock3 = lcStringBlock3 + '#T178.0#J'+str(lnOffset+50)+'#YT107/2///(420)'+alltrim(sfsship_zip)+'#G'
ENDIF
...
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+56)+'#YT103/2///'+'PO: '+alltrim(po_num)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T170.0#J'+str(lnOffset+56)+'#YT103/2///'+'DEPT: '+alltrim(department)+'#G'
*- lcStringBlock3 = lcStringBlock3 + '#T150.0#J'+str(lnOffset+72)+'#YT104/2///'+'CARTON ____ OF ____#G'
if lnSKUCount = 1 then    && Bulk pack
  lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+64)+'#YT103/2///'+'STYLE: '+alltrim(style)+'#G'
  lcStringBlock3 = lcStringBlock3 + '#T170.0#J'+str(lnOffset+64)+'#YT103/2///'+'COLOR: '+alltrim(sfscolor_name)+'#G'
  *- lcStringBlock3 = lcStringBlock3 + '#T140.0#J'+str(lnOffset+64)+'#YT103/2///'+'SIZE: '+alltrim(size_desc)+'#G'
  lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+70)+'#YT103/2///'+'SIZE: '+alltrim(size_desc)+'#G'
  lcStringBlock3 = lcStringBlock3 + '#T140.0#J'+str(lnOffset+56)+'#YT103/2///'+'QTY: '+alltrim(str(lnTotalBlockQty))+'#G'
ELSE 
if alltrim(store)<>'00601' and alltrim(store)<>'05099' and alltrim(store)<>'05899' then    && Pack by store
  lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+64)+'#YT103/2///'+'SO##:'+alltrim(str(ord_num))+'#G'
  lcStringBlock3 = lcStringBlock3 + '#T170.0#J'+str(lnOffset+64)+'#YT103/2///'+'WEIGHT:'+alltrim(str(carton_wgt))+'#G'
  lcStringBlock3 = lcStringBlock3 + '#T140.0#J'+str(lnOffset+56)+'#YT103/2///'+'QTY: '+alltrim(str(lnTotalBlockQty))+'#G'
else  && Pre-pack bulk
  lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+60)+'#YT103/2///'+'STYLE: '+alltrim(style)+'#G'
  lcStringBlock3 = lcStringBlock3 + '#T170.0#J'+str(lnOffset+60)+'#YT103/2///'+'COLOR: '+alltrim(sfscolor_name)+'#G'
  lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+64)+'#YT103/2///SIZE#G'
  lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+68)+'#YT103/2///QTY#G'
  select curPart1
  go top
	for lnIndbucket=2 to 9
		lcIndbucket=TRANS(lnIndbucket,"@L 99")
		lcStringBlock3=lcStringBlock3+ ;
			'#T'+str(180-((lnIndbucket-2)*10))+'#J'+str(lnOffset+64)+'#YT103/2///'+ ;
	...
	for lnIndbucket=2 to 9
		if explarr[lnIndbucket] > 0 then
			lcIndbucket=TRANS(lnIndbucket,"@L 99")
			lcStringBlock3=lcStringBlock3+ ;
				'#T'+str(180-((lnIndbucket-2)*10))+'#J'+str(lnOffset+68)+'#YT103/2///'+ ;
				alltrim(str(explarr[lnIndbucket]))+'#G'
		endif
	endfor
	lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+72)+'#YT103/2///PACK QTY: '+str(explarr[1])+'#G'
    lcStringBlock3 = lcStringBlock3 + '#T140.0#J'+str(lnOffset+56)+'#YT103/2///'+'QTY: '+alltrim(str(lnTotalBlockQty/explarr[1]))+'#G'
endif
endif
...
DO WHILE LEN(lcStore) < 5 
  lcStore = '0'+lcStore
ENDDO 
&& lcStringBlock3 = lcStringBlock3 + '#T93.0#J'+STR(lnOffset+24)+'#YB15/2O/3/5///91'+substr(alltrim(lcStore),2)+'#G'
&& lcStringBlock3 = lcStringBlock3 + '#T85.0#J'+STR(lnOffset+28)+'#YT107/2///(91)'+alltrim(lcStore)+'#G'

*- Zone H (Mark for store # [text])

lcStringBlock3 = lcStringBlock3 + '#T50.0#J'+str(lnOffset+4)+'#YT105/2///'+'STORE:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T47.0#J'+str(lnOffset+22)+'#M2/3#YT109/2///'+alltrim(store)+'#G#M1/1'
if alltrim(store)<>'00601' and alltrim(store)<>'05099' and alltrim(store)<>'05899' then    && Pack by store
	lcStringBlock3 = lcStringBlock3 + '#T50.0#J'+str(lnOffset+28)+'#YT106/2///'+alltrim(sfsmark_city)+', '+alltrim(sfsmark_state)+'  '+alltrim(sfsmark_zip)+'#G'
else && Pre-pack bulk
	lcStringBlock3 = lcStringBlock3 + '#T50.0#J'+str(lnOffset+28)+'#YT106/2///'+alltrim(sfsship_city)+', '+alltrim(sfsship_state)+'  '+alltrim(sfsship_zip)+'#G'
endif
*- Zone I (Carton # [UCC128])

lcStringBlock3 = lcStringBlock3 + '#T93.0#J'+str(lnOffset+73)+'#YB15/2M/5.25/6///'+alltrim(carton_num)+'#G'
