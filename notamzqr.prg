...
DO WHILE NOT EOF('CurPart2Final') 
	...
	lnOffset = (lnPageNum - 1) * 79
	lcQRString='AMZN,PO:'+allt(po_num)
	...
	*- second column header
	...
	DO WHILE !eof('curPart2Final') AND lnIndLineBlock2<=MaxNbLineBlock2
		...
		if total_qty > 0 then 
			lcQRString = lcQRString + ',UPC:'+allt(SKU_UPC)+',QTY:'+allt(str(Total_qty))
		endif
		if total_qty_col2 > 0 then
			lcQRString = lcQRString + ',UPC:'+allt(SKU_UPC_col2)+',QTY:'+allt(str(total_qty_col2))
		endif
		*- Detail line
		*- -----------
...
lcStringBlock3 = lcStringBlock3 + '#T140.1#J'+str(lnOffset+22)+'#YL0/1/1/28#G'
...
zoneCheight = 3 * lnhfactor
IF len(ALLTRIM(sfsship_zip))>5
  lcStringBlock3 = lcStringBlock3 + '#T188.0#J'+str(lnOffset+45)+'#YB15/2O/'+alltrim(str(zoneCheight))+'/5///420'+substr(sfsship_zip,1,5)+'#G'
  lcStringBlock3 = lcStringBlock3 + '#T178.0#J'+str(lnOffset+49)+'#YT107/2///(420)'+substr(sfsship_zip,1,5)+'#G'
ELSE
  lcStringBlock3 = lcStringBlock3 + '#T188.0#J'+str(lnOffset+45)+'#YB15/2O/'+alltrim(str(zoneCheight))+'/5///420'+alltrim(sfsship_zip)+'#G'
...
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+65)+'#YT108/2///'+'DEPT: '+alltrim(department)+'#G'
*lcStringBlock3 = lcStringBlock3 + '#T160.0#J'+allt(str(lnOffset+72))+'#SPF1/2/0/0/4/1#G#FD/2/L#VW/L/'+lcQRString+'#G'
lcStringBlock3 = lcStringBlock3 + '#VDT/QRBC1////'+lcQRString+'#G'
lcStringBlock3 = lcStringBlock3 + '#T140.0#J'+allt(str(lnOffset+73))+'#SQR2/MA/5///#G#FD/2/L#VW/L/QRBC1#G'
...
zoneIheight = 5.5 * lnhfactor
lcStringBlock3 = lcStringBlock3 + '#T93.0#J'+str(lnOffset+70)+'#YB15/2M/'+alltrim(str(zoneIheight))+'/6///'+alltrim(carton_num)+'#G'
