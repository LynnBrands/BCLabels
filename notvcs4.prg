...
*- Zone D (Carrier, etc.)
lcStringBlock3 = lcStringBlock3 + '#T36.0#J'+str(lnOffset+27)+'#YT102/2///Carrier:'+alltrim(sfs_scaccode)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T36.0#J'+str(lnOffset+34)+'#YT105/2///Carton __1__ OF __1__#G'
