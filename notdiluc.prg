...
*- this Foxpro program NOTDILUC.PRG (orig: NOTPCLUC.PRG)
...
*- PART 3: UCC128 part of the label - DILLARDS (04/21/05)
*- ----------------------------------------------------------------------------------------------------------------------- -*
...
lcStringBlock3 = lcStringBlock3 + '#T203.2#J'+str(lnOffset+23)+'#YL0/2/1/101.6#G'
lcStringBlock3 = lcStringBlock3 + '#T203.2#J'+str(lnOffset+45)+'#YL0/2/1/101.6#G'
lcStringBlock3 = lcStringBlock3 + '#T159.3#J'+str(lnOffset+0)+'#YL0/1/1/23#G'
...
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+25)+'#YT100/2///SHIP TO POSTAL CODE#G'
lcStringBlock3 = lcStringBlock3 + '#T170.0#J'+str(lnOffset+39)+'#YB15/2O/1.5/5///420'+alltrim(sfsship_zip)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T170.0#J'+str(lnOffset+43)+'#YT107/2///(420)'+alltrim(sfsship_zip)+'#G'

*- Zone D (Carrier, etc.)

&& Dillards doesn't use zone D

*- Zone E (PO / Dept)

&& Dillards requires the PO # to be barcoded, and department to be in Zone H.
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+47)+'#YT100/2///PO:#G'
lcStringBlock3 = lcStringBlock3 + '#T180.0#J'+str(lnOffset+65)+'#YB15/2O/2.5/5///400'+alltrim(po_num)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T170.0#J'+str(lnOffset+69)+'#YT107/2///(400)'+alltrim(po_num)+'#G'

*- Zone F (if not combined with Zone E)

*- Zone G (Mark for store # [UCC128])

lcStringBlock3 = lcStringBlock3 + '#T100.0#J'+str(lnOffset+5)+'#YT105/2///'+'FOR STORE:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T100.0#J'+str(lnOffset+14)+'#YT109/2///'+alltrim(store)+'#G'

*- Zone H (Mark for store # [text])

lcStringBlock3 = lcStringBlock3 + '#T70.0#J'+str(lnOffset+12)+'#YT108/2///'+'DEPT: '+alltrim(department)+'#G'
