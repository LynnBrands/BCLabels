...
*- this Foxpro program NOTBOSUC.PRG (orig: NOTPCLUC.PRG)
...
*- PART 3: UCC128 part of the label - BOSCOV (5/18/2005)
*- ----------------------------------------------------------------------------------------------------------------------- -*
...
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+35)+'#YT108/2///'+'PO: '+alltrim(po_num)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+40)+'#YT108/2///'+'ITEM ##: '+alltrim(SKU_UPC)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+45)+'#YT108/2///'+'Qty: '+alltrim(str(lnTotalBlockQty))+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+50)+'#YT108/2///Gross Weight: '+ALLTRIM(str(carton_wgt,10,2))+' lbs#G'
lcStringBlock3 = lcStringBlock3 + '#T195.0#J'+str(lnOffset+70)+'#YB23/2M/2/3///'+alltrim(SKU_UPC)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T135.0#J'+str(lnOffset+70)+'#YB23/2M/2/3///'+alltrim(str(lnTotalBlockQty))+'#G'
