...
*- PART 3: UCC128 part of the label - NEXCOM (05/19/2005)
*- ----------------------------------------------------------------------------------------------------------------------- -*
...
#DEFINE MaxNbLineBlock1 10
#DEFINE MaxNbLineBlock2 10
#DEFINE MaxNbLineBlock3 24
...
lcStringBlock3 = lcStringBlock3 + '#T51.5#J'+str(lnOffset+0)+'#YL0/1/1/25#G'
...
lcStringBlock3 = lcStringBlock3 + '#T188.0#J'+str(lnOffset+45)+'#YB15/2O/2.5/5///420'+SUBSTR(alltrim(sfsship_zip),1,5)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T178.0#J'+str(lnOffset+49)+'#YT106/2///(420)'+SUBSTR(alltrim(sfsship_zip),1,5)+'#G'

*- Zone D (Carrier, etc.)

lcStringBlock3 = lcStringBlock3 + '#T136.0#J'+str(lnOffset+31)+'#YT102/2///Carrier:#G'
lcStringBlock3 = lcStringBlock3 + '#T136.0#J'+str(lnOffset+37)+'#YT102/2///BOL:#G'

*- Zone E (PO / Dept)

lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+57)+'#YT109/2///'+'PO: '+alltrim(po_num)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T200.0#J'+str(lnOffset+65)+'#YT109/2///'+'DEPT: '+alltrim(department)+'#G'
&& The spec says we should have a line from SAC15 of the 850 for promotions; but none of the POs we have contain this segment, so I don't know where to get it from.
lcStringBlock3 = lcStringBlock3 + '#T140.0#J'+str(lnOffset+65)+'#YT106/2///'+'Carton ____ of ____#G'
...
ENDIF
lcStringBlock3 = lcStringBlock3 + '#T93.0#J'+STR(lnOffset+19)+'#YB15/2O/2.5/5///910'+ALLTRIM(lcStore)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T83.0#J'+str(lnOffset+23)+'#YT106/2///(91)0'+alltrim(lcStore)+'#G'
...
ENDIF
lcStringBlock3 = lcStringBlock3 + '#T50.0#J'+str(lnOffset+4)+'#YT101/2///'+'FOR:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#T49.0#J'+str(lnOffset+8)+'#YT105/2///'+alltrim(sfsstore_name)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T50.0#J'+str(lnOffset+11)+'#YT101/2///'+'STORE:'+'#G'
lcStringBlock3 = lcStringBlock3 + '#M2/2#T49.0#J'+str(lnOffset+22)+'#YT108/2///'+alltrim(store)+'#G#M1/1'

*- Zone I (Carton # [UCC128])

lcStringBlock3 = lcStringBlock3 + '#T93.0#J'+str(lnOffset+69)+'#YB15/2O/7/6///'+alltrim(carton_num)+'#G'
lcStringBlock3 = lcStringBlock3 + '#T83.0#J'+str(lnOffset+73)+'#YT105/2///'+alltrim(carton_num)+'#G'
...
PARAMETERS parm_ordnum, parm_picknum
  ...
  lcSQLQuery = "SELECT value FROM zzedatawhse WHERE ord_num="+alltrim(str(parm_ordnum))+;
               " AND segment='REF' and qualifier='PG'"

  = v_SQLPrep(lcSQLQuery,'fobname','')
  if used('fobname') and reccount('fobname')>0
    *- We have a range style
    lcSQLReturn = fobname.value
  else
    lcSQLReturn = ""
  endif
